...
def ini_log(level: str = "INFO"):
    ...
    r_logger.log(base_lvl, f"Current level: {str(level).upper()}. Usage: python run.py (cmd/pwsh), if you want to enable debug mode, add the '--debug' flag after the execution command, although anything more severe than 'INFO' will be logged automatically.")
